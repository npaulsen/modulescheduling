...
public class ImmutableListWithValueSemantics<T> : IImmutableList<T>, IEquatable<IImmutableList<T>>
{
    ...
    public override int GetHashCode()
    {
        unchecked
        {
            return this.Aggregate(19, (h, i) => h * 19 + i?.GetHashCode() ?? 1);
        }
    }
...
public static class Ex
{
    ...
    public static ImmutableListWithValueSemantics<T> ToValueList<T>(this IEnumerable<T> enumerable)
        => enumerable.ToList().ToImmutableList().WithValueSemantics();
